...
public class HelpDialog {
    ...
    public void showEditConfigHelp() {
        ...
        "Performance value:\n" +
        "All components have a performance value which represent the performance a user can expect.\n" +
        ...
        "The total performance value is used to illustrate the performance a user can expected from their configuration\n " +
